<h2><a href="https://leetcode.com/problems/daily-temperatures/">728. Self Dividing Numbers</a></h2><h3>Easy</h3><hr><p>A <strong>self-dividing number</strong> is a number that is divisible by every digit it contains.</p>
